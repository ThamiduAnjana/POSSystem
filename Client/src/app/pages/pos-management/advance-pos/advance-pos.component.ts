...
@Component({
  selector: 'app-advance-pos',
  templateUrl: './advance-pos.component.html',
  styleUrls: ['./advance-pos.component.scss']
})
export class AdvancePosComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  openProductsViewModal(modal:any) {
    this.modalProductsViewRef =  this.modalService.open(modal, {size: 'xl', keyboard: false, backdrop: 'static'});
  }

  closeProductsViewModal() {
    this.modalProductsViewRef.close();
  }
